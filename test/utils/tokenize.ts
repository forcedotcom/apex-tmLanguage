...
export namespace Token {
    export namespace Comment {
        export const LeadingWhitespace = (text: string) => createToken(text, 'punctuation.whitespace.comment.leading.apex');

        export namespace MultiLine {
            export const End = createToken('*/', 'punctuation.definition.comment.apex');
            export const Start = createToken('/*', 'punctuation.definition.comment.apex');
            export const JavaDocStart = createToken('/**', 'punctuation.definition.comment.apex');

            export const Text = (text: string) => createToken(text, 'comment.block.apex');
        }

        export namespace SingleLine {
            export const Start = createToken('//', 'punctuation.definition.comment.apex');

            export const Text = (text: string) => createToken(text, 'comment.line.double-slash.apex');
        }
    }
    ...
    export namespace Identifiers {
        ...
        export const MethodName = (text: string) => createToken(text, 'entity.name.function.apex');
        export const NamespaceName = (text: string) => createToken(text, 'entity.name.type.namespace.apex');
        export const ParameterName = (text: string) => createToken(text, 'entity.name.variable.parameter.apex');
        export const PropertyName = (text: string) => createToken(text, 'entity.name.variable.property.apex');
        export const RangeVariableName = (text: string) => createToken(text, 'entity.name.variable.range-variable.apex');
        export const StructName = (text: string) => createToken(text, 'entity.name.type.struct.apex');
        export const TupleElementName = (text: string) => createToken(text, 'entity.name.variable.tuple-element.apex');
        export const TypeParameterName = (text: string) => createToken(text, 'entity.name.type.type-parameter.apex');
    }

    export namespace Keywords {
        export namespace Control {
            export const Break = createToken('break', 'keyword.control.flow.break.apex');
            export const Case = createToken('case', 'keyword.control.case.apex');
            export const Catch = createToken('catch', 'keyword.control.try.catch.apex');
            export const Continue = createToken('continue', 'keyword.control.flow.continue.apex');
            export const Default = createToken('default', 'keyword.control.default.apex');
            export const Do = createToken('do', 'keyword.control.loop.do.apex');
            export const Else = createToken('else', 'keyword.control.conditional.else.apex');
            export const Finally = createToken('finally', 'keyword.control.try.finally.apex');
            export const For = createToken('for', 'keyword.control.loop.for.apex');
            export const ForEach = createToken('foreach', 'keyword.control.loop.foreach.apex');
            ...
            export const While = createToken('while', 'keyword.control.loop.while.apex');
            export const Yield = createToken('yield', 'keyword.control.flow.yield.apex');
        }
        ...
        export namespace Modifiers {
            ...
            export const WithoutSharing = createToken('without sharing', 'sharing.modifier.apex');
            export const WithSharing = createToken('with sharing', 'sharing.modifier.apex');
        }
        ...
        export const Alias = createToken('alias', 'keyword.other.alias.apex');
        export const AttributeSpecifier = (text: string) => createToken(text, 'keyword.other.attribute-specifier.apex');
        ...
        export const Implicit = createToken('implicit', 'keyword.other.implicit.apex');
        ...
        export const Lock = createToken('lock', 'keyword.other.lock.apex');
        export const NameOf = createToken('nameof', 'keyword.other.nameof.apex');
        export const Namespace = createToken('namespace', 'keyword.other.namespace.apex');
        export const New = createToken('new', 'keyword.other.new.apex');
        export const Operator = createToken('operator', 'keyword.other.operator-decl.apex');
        ...
        export const Struct = createToken('struct', 'keyword.other.struct.apex');
    ...
    export namespace Literals {
        export namespace Boolean {
            export const False = createToken('false', 'constant.language.boolean.false.apex');
            export const True = createToken('true', 'constant.language.boolean.true.apex');
        }

        export const Null = createToken('null', 'constant.language.null.apex');

        export namespace Numeric {
            export const Binary = (text: string) => createToken(text, 'constant.numeric.binary.apex');
            export const Decimal = (text: string) => createToken(text, 'constant.numeric.decimal.apex');
    ...
    export namespace Operators {
        export namespace Arithmetic {
            export const Addition = createToken('+', 'keyword.operator.arithmetic.apex');
            export const Division = createToken('/', 'keyword.operator.arithmetic.apex');
            export const Multiplication = createToken('*', 'keyword.operator.arithmetic.apex');
            export const Remainder = createToken('%', 'keyword.operator.arithmetic.apex');
            export const Subtraction = createToken('-', 'keyword.operator.arithmetic.apex');
        }

        export namespace Bitwise {
            export const And = createToken('&', 'keyword.operator.bitwise.apex');
            export const BitwiseComplement = createToken('~', 'keyword.operator.bitwise.apex');
            export const ExclusiveOr = createToken('^', 'keyword.operator.bitwise.apex');
            export const Or = createToken('|', 'keyword.operator.bitwise.apex');
            export const ShiftLeft = createToken('<<', 'keyword.operator.bitwise.shift.apex');
            export const ShiftRight = createToken('>>', 'keyword.operator.bitwise.shift.apex');
        }
        ...
        export namespace Conditional {
            export const QuestionMark = createToken('?', 'keyword.operator.conditional.question-mark.apex');
            export const Colon = createToken(':', 'keyword.operator.conditional.colon.apex');
        }
        ...
        export namespace Relational {
            export const Equals = createToken('==', 'keyword.operator.comparison.apex');
            export const NotEqual = createToken('!=', 'keyword.operator.comparison.apex');

            export const LessThan = createToken('<', 'keyword.operator.relational.apex');
            export const LessThanOrEqual = createToken('<=', 'keyword.operator.relational.apex');
            export const GreaterThan = createToken('>', 'keyword.operator.relational.apex');
        ...
        export const NullCoalescing = createToken('??', 'keyword.operator.null-coalescing.apex');
        export const NullConditional = createToken('?', 'keyword.operator.null-conditional.apex');
    }
    ...
    export namespace Punctuation {
        ...
        export namespace TypeParameters {
            export const Begin = createToken('<', 'punctuation.definition.typeparameters.begin.apex');
            export const End = createToken('>', 'punctuation.definition.typeparameters.end.apex');
        }

        export const Accessor = createToken('.', 'punctuation.accessor.apex');
        export const CloseBrace = createToken('}', 'punctuation.curlybrace.close.apex');
        export const CloseBracket = createToken(']', 'punctuation.squarebracket.close.apex');
        export const CloseParen = createToken(')', 'punctuation.parenthesis.close.apex');
        export const Colon = createToken(':', 'punctuation.separator.colon.apex');
        export const ColonColon = createToken('::', 'punctuation.separator.coloncolon.apex');
        ...
        export const OpenBrace = createToken('{', 'punctuation.curlybrace.open.apex');
        export const OpenBracket = createToken('[', 'punctuation.squarebracket.open.apex');
        export const OpenParen = createToken('(', 'punctuation.parenthesis.open.apex');
        export const QuestionMark = createToken('?', 'punctuation.separator.question-mark.apex');
        export const Semicolon = createToken(';', 'punctuation.terminator.statement.apex');
        export const Tilde = createToken('~', 'punctuation.tilde.apex');
    }

    export namespace Variables {
        export const Alias = (text: string) => createToken(text, 'variable.other.alias.apex');
        export const Object = (text: string) => createToken(text, 'variable.other.object.apex');
        export const Property = (text: string) => createToken(text, 'variable.other.object.property.apex');
        export const ReadWrite = (text: string) => createToken(text, 'variable.other.readwrite.apex');
    }

    export namespace XmlDocComments {
        export namespace Attribute {
            export const Name = (text: string) => createToken(text, 'entity.other.attribute-name.localname.apex');
        }

        export namespace CData {
            export const Begin = createToken('<![CDATA[', 'punctuation.definition.string.begin.apex');
            export const End = createToken(']]>', 'punctuation.definition.string.end.apex');
            export const Text = (text: string) => createToken(text, 'string.unquoted.cdata.apex');
        }

        export namespace CharacterEntity {
            export const Begin = createToken('&', 'punctuation.definition.constant.apex');
            export const End = createToken(';', 'punctuation.definition.constant.apex');
            export const Text = (text: string) => createToken(text, 'constant.character.entity.apex');
        }

        export namespace Comment {
            export const Begin = createToken('<!--', 'punctuation.definition.comment.apex')
            export const End = createToken('-->', 'punctuation.definition.comment.apex')
            export const Text = (text: string) => createToken(text, 'comment.block.apex')
        }
        ...
        export namespace Tag {
            // punctuation
            export const StartTagBegin = createToken('<', 'punctuation.definition.tag.apex');
            export const StartTagEnd = createToken('>', 'punctuation.definition.tag.apex');
            export const EndTagBegin = createToken('</', 'punctuation.definition.tag.apex');
            export const EndTagEnd = createToken('>', 'punctuation.definition.tag.apex');
            export const EmptyTagBegin = createToken('<', 'punctuation.definition.tag.apex');
            export const EmptyTagEnd = createToken('/>', 'punctuation.definition.tag.apex');

            export const Name = (text: string) => createToken(text, 'entity.name.tag.localname.apex');
        }
        ...
        export namespace String {
            export namespace DoubleQuoted {
                export const Begin = createToken('"', 'punctuation.definition.string.begin.apex');
                export const End = createToken('"', 'punctuation.definition.string.end.apex');
                export const Text = (text: string) => createToken(text, 'string.quoted.double.apex');
            }

            export namespace SingleQuoted {
                export const Begin = createToken('\'', 'punctuation.definition.string.begin.apex');
                export const End = createToken('\'', 'punctuation.definition.string.end.apex');
                export const Text = (text: string) => createToken(text, 'string.quoted.single.apex');
            }
        }
